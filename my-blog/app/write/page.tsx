    ...
    return (
        <main className='max-w-2xl mx-auto p-4'>
            ...
            <form onSubmit={handleSubmit} className='space-y-4'>
                ...
                <textarea placeholder='文章内容（支持 Markdown）' value={content} className="textarea textarea-primary input-bordered w-full h-60" required onChange={e => setContent(e.target.value)} />
